...
def build_parser() -> argparse.ArgumentParser:
    ...
    sp.add_argument("--executor-tmux-command", help="Command used to launch isolated executor tmux sessions")
    sp.add_argument("--reviewer-tmux-command", help="Command used to launch isolated reviewer tmux sessions")
